...
export function ServicesGrid() {
  return (
    <section className="relative min-h-[auto] flex items-center py-12 md:py-16 bg-white selection:bg-brand-gray overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start lg:items-stretch">
          ...
          <div className="w-full lg:w-1/3 flex flex-col justify-center space-y-6 animate-in fade-in slide-in-from-left-8 duration-1000">
            <div className="space-y-4 lg:space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-green/10 border border-brand-green/20 rounded-full text-brand-green text-[10px] font-black uppercase tracking-wider">
               ...
               <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-brand-navy leading-[1.05] italic tracking-tighter">
                Engineering <br/> The <span className="text-brand-green 4">Future.</span>
              </h2>
              <p className="text-brand-gray0 font-medium text-base max-w-sm leading-relaxed">
                Comprehensive engineering, procurement, and construction solutions for the modern power sector.
              </p>
            </div>

            <div className="space-y-3 pt-6 border-t border-brand-gray">
          ...
          <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 items-stretch animate-in fade-in slide-in-from-right-8 duration-1000 delay-200">
            {services.map((service, index) => {
              ...
              return (
                <Link 
                  ...
                  className={cn(
                    "group relative p-6 lg:p-8 rounded-[2.5rem] transition-all duration-500 border overflow-hidden flex flex-col justify-between min-h-[280px] lg:min-h-0",
                    service.featured 
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className={cn(
                      "w-10 h-10 lg:w-12 lg:h-12 rounded-2xl flex items-center justify-center mb-4 lg:mb-8 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3",
                    ...
                    <div className="space-y-3 lg:space-y-4">
                      <h3 className={cn(
                        "text-lg lg:text-xl font-black italic tracking-tighter transition-colors",
                  ...
                  <div className="relative z-10 pt-6 lg:pt-8 flex items-center justify-between">
                    <div className={cn(
                    ...
                    <div className={cn(
                      "w-8 h-8 lg:w-10 lg:h-10 rounded-full flex items-center justify-center transition-all duration-500 shadow-sm",
