      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-1 space-y-6">
            <h2 className="text-sm font-bold text-brand-green uppercase tracking-[0.2em]">Our Capabilities</h2>
            <h3 className="text-4xl font-bold text-slate-900 dark:text-white leading-tight">
              Engineering Excellence Across the <span className="text-brand-green">Power Value Chain.</span>
            </h3>
            ...
            <div className="pt-4">
              <div className="p-6 bg-brand-gray dark:bg-slate-900 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800">
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
            {capabilities.map((cap) => (
              <div 
                key={cap.title} 
                className="p-8 rounded-2xl bg-white dark:bg-slate-900 border border-brand-gray dark:border-slate-800 hover:border-brand-green/30 transition-all group"
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-brand-green/10 rounded-xl text-brand-green group-hover:bg-brand-green group-hover:text-white transition-colors">
                    <cap.icon size={24} />
                  </div>
                  <div className="space-y-2">
                    <h4 className="font-bold text-slate-900 dark:text-white group-hover:text-brand-green transition-colors">
                      {cap.title}
                    </h4>
                    <p className="text-sm text-brand-gray0 dark:text-slate-400 leading-relaxed">
                      {cap.description}
                    </p>
                  </div>
                </div>
