        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-sm font-bold text-brand-green uppercase tracking-[0.2em]">Stability Pillar</h2>
            ...
            <div className="pt-4 flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4 p-4 border border-white/10 rounded-2xl bg-white/5">
                <div className="w-12 h-12 bg-brand-green text-brand-navy rounded-xl flex items-center justify-center shrink-0">
                  <ShieldCheck size={28} />
                </div>
          ...
          <div className="relative">
             <div className="absolute inset-0 bg-brand-green/10 blur-[100px] rounded-full" />
                   ...
                   <div key={idx} className="p-8 bg-white/5 border border-white/5 rounded-3xl group hover:bg-white/10 transition-all">
                      <div className="flex gap-8 items-center">
                         ...
                         <div>
                            ...
                            <p className="text-brand-gray0 text-sm font-medium">{step.desc}</p>
                         </div>
                      </div>
                   </div>
                ))}
