...
export function WhatWeDo() {
  return (
    <section className="py-16 md:py-24 bg-white dark:bg-brand-navy">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 items-start">
          {/* Header Area */}
          <div className="lg:w-1/3 space-y-4 md:space-y-6 lg:sticky lg:top-32">
            <h2 className="text-sm font-bold text-brand-green uppercase tracking-[0.2em]">Our Mandate</h2>
            <h3 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white leading-tight">
              What <span className="text-brand-green">We Do</span>
            </h3>
          ...
          <div className="lg:w-2/3 space-y-8 md:space-y-12">
            <div className="prose prose-xl prose-slate dark:prose-invert max-w-none">
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg pt-4 md:pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-6 md:pt-8">
              {[
                ...
                <div key={idx} className="flex gap-4 p-6 bg-brand-gray dark:bg-slate-900 rounded-3xl border border-brand-gray dark:border-slate-800 group hover:border-brand-green/50 transition-all">
                  <div className="p-3 bg-white dark:bg-brand-navy text-brand-green rounded-2xl shadow-sm group-hover:scale-110 transition-transform">
                    <pill.icon size={24} />
                  </div>
                  <div className="space-y-1">
                    <h4 className="font-bold text-slate-900 dark:text-white">{pill.title}</h4>
                    <p className="text-xs text-brand-gray0 dark:text-slate-400 font-medium leading-snug">{pill.desc}</p>
                  </div>
                </div>
              ))}
            </div>
