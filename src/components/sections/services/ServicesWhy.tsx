          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8 relative z-10">
              <div className="space-y-4">
                <h2 className="text-sm font-bold text-amber-500 uppercase tracking-[0.2em]">The Advantage</h2>
            ...
            <div className="space-y-4 relative z-10">
              {points.map((point, idx) => (
                <div 
                  key={idx} 
                  className="flex items-center gap-6 p-6 bg-white/5 border border-white/5 rounded-3xl hover:bg-white/10 transition-all hover:border-amber-500/30 group"
                >
                  <div className="p-3 bg-white/5 text-amber-500 rounded-xl group-hover:scale-110 transition-transform">
                    <point.icon size={24} />
                  </div>
