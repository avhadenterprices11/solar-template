    ...
    <section className="relative pt-40 pb-32 bg-white overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="text-6xl md:text-[9rem] font-black text-brand-navy italic tracking-tighter leading-[0.85] mb-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100">
            Get in <br/> <span className="text-brand-green underline decoration-brand-gray underline-offset-[20px]">Touch.</span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-200">
            <p className="text-xl md:text-2xl text-brand-gray0 font-bold leading-tight max-w-xl italic">
              Connect with us for reliable electrical, solar, and power solutions tailored to your project needs. We&apos;re here to power your vision with uncompromised quality.
            </p>
