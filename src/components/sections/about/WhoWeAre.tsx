      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative group">
            <div className="absolute -top-12 -left-12 w-48 h-48 bg-amber-500/10 rounded-full blur-3xl group-hover:scale-150 transition-transform duration-1000" />
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="p-8 bg-slate-900 rounded-3xl space-y-2">
                  <p className="text-3xl font-black text-amber-500">33kV</p>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Industry Specialization</p>
                </div>
                <div className="p-8 bg-amber-500 rounded-3xl space-y-2">
                  <p className="text-3xl font-black text-slate-950">EPC</p>
                  <p className="text-[10px] font-bold text-slate-950/60 uppercase tracking-widest">Full-Cycle Delivery</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-sm font-bold text-amber-500 uppercase tracking-[0.2em]">The Identity</h2>
              <h3 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white leading-tight underline decoration-amber-500/30 underline-offset-8">
                Who We Are
              </h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-8 pt-6">
              {[
                ...
                <div key={idx} className="flex items-center gap-3">
                  <div className="p-2 bg-slate-50 dark:bg-slate-900 text-amber-500 rounded-lg border border-slate-100 dark:border-slate-800">
                    <item.icon size={20} />
                  </div>
