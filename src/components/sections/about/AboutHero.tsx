    ...
    <section className="relative h-[60vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center lg:text-left">
        <div className="max-w-4xl space-y-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-500/10 border border-amber-500/20 rounded-full text-amber-500 text-xs font-bold uppercase tracking-widest animate-in fade-in slide-in-from-left-4 duration-700">
            About the Company
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-white leading-tight animate-in fade-in slide-in-from-top-4 duration-700 delay-100">
            Building Reliable Power Infrastructure for a <span className="text-amber-500 text-glow">Sustainable Future.</span>
          </h1>
