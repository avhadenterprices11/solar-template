    ...
    <section className="py-24 bg-white dark:bg-brand-navy">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          <div className="lg:w-1/3 border-l-4 border-brand-green pl-8 space-y-4">
             <h2 className="text-sm font-black text-brand-green uppercase tracking-widest leading-none">History</h2>
          ...
          <div className="lg:w-2/3 space-y-8">
             ...
             <p className="text-brand-gray0 dark:text-slate-400 leading-relaxed max-w-2xl">
