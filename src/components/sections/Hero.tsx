  ...
  return (
    <section className="relative h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl space-y-10 pt-32 md:pt-40">
          {/* Badge */}
          <div className="inline-flex items-center gap-3 px-4 py-2 bg-brand-green/10 border border-brand-green/20 rounded-full text-brand-green text-[10px] font-black uppercase tracking-[0.2em] animate-in fade-in slide-in-from-left-4 duration-1000">
            <Zap size={14} className="fill-brand-green" />
            Leading India&apos;s Energy Transformation
          </div>

          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-white leading-[0.85] italic tracking-tighter animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
            Powering <br/>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-400">
            <p className="text-lg md:text-xl text-brand-gray/80 font-bold leading-tight italic max-w-xl">
          ...
          <div className="flex items-center gap-3 text-slate-400 animate-in fade-in duration-700 delay-500">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em]">Working with Government & Industrial Clients across India</span>
          </div>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-center gap-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-700">
            <Link
              href="/contact"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-4 bg-brand-green text-brand-navy px-12 py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-white hover:scale-105 transition-all duration-500 shadow-2xl shadow-brand-green/20 group"
            >
              Get a Quote
